...
public class Emprunteur extends Personne implements java.io.Serializable {
    ...
    /**
     * Constructeur de la classe Emprunteur Il construit un Emprunteur avec son
     * nom passe en parametre, son prenom et sa duree max d'Emprunt
     * 
     * @param nom
     ...
     * @param duree
     *            La duree max d'emprunt de la personne
     */
    ...
    /**
     * Methode publique utilisee pour acceder a la valeur nombre d'emprunts de
     * la classe a partir d'une autre classe.
     * 
    ...
    /**
     * Methode publique utilisee pour modifier la valeur du nombre d'emprunt de
     * la personne a partir d'une autre classe.
     * 
     * @param nombreEmprunts
     *            Entier representant le nombre d'emprunts que la personne a
     *            effectue
     */
    ...
    /**
     * Methode publique utilisee pour incrementer la valeur du nombre d'emprunt
     * de la personne a partir d'une autre classe.
     * 
     * @param nbrEmprunt
     *            Entier representant le nombre d'emprunts ajoute.
     */
