...
/**
 * Un Professeur est un Emprunteur les Professeurs qui peuvent emprunter
 * plusieurs matériels pour un cours donné. Les enseignants peuvent garder le
...
public class Professeur extends Emprunteur implements java.io.Serializable {
    ...
    /**
     * Constructeur de la classe Professeur Il construit un Emprunteur avec son
     * nom passe en parametre et son prenom
     * 
     * @param nom
    ...
    /**
     * Constructeur de la classe Professeur. Il cree une personne avec objet
     * Personne passe en parametre. Il reprend les informations de la personne
     * et modifie le nombre d'emprunts.
     * 
     * @param utilisateur
