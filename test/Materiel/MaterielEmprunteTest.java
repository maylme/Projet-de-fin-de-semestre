...
public class MaterielEmprunteTest {
    ...
    public void testMaterielEmprunteMaterielEmprunteurDateInt() {
        ...
        MaterielEmprunte mat = new MaterielEmprunte(expectedMat,
                expectedEmprunteur, expectedDate, expectedDureeEmprunt);
        ...
        MaterielEmprunte mat1 = new MaterielEmprunte(expectedMat1,
                expectedEmprunteur, expectedDate, expectedDureeEmprunt);
        ...
        MaterielEmprunte mat2 = new MaterielEmprunte(expectedMat,
                expectedEmprunteur2, expectedDate, expectedDureeEmprunt);
        ...
        MaterielEmprunte mat3 = new MaterielEmprunte(expectedMat,
                expectedEmprunteur, expectedDate3, expectedDureeEmprunt);
    ...
    public void testGetMatEmprunt() {
        Materiel expectedMat = new Materiel();
        MaterielEmprunte mat = new MaterielEmprunte(expectedMat,
                new Emprunteur(), new Date(), 10);
        if (mat.getMatEmprunt() != expectedMat)
            fail("mauvais materiel");
        Materiel matEmprunt = null;
        MaterielEmprunte mat2 = new MaterielEmprunte(matEmprunt,
                new Emprunteur(), new Date(), 10);
    ...
    public void testGetEmprunteur() {
        Emprunteur expectedEmprunteur = new Emprunteur();
        MaterielEmprunte mat = new MaterielEmprunte(new Materiel(),
                expectedEmprunteur, new Date(), 10);
        if (mat.getEmprunteur() != expectedEmprunteur)
            fail("mauvais emprunteur");
        Emprunteur emprunteur = null;
        MaterielEmprunte mat2 = new MaterielEmprunte(new Materiel(),
                emprunteur, new Date(), 10);
    ...
    public void testGetDateEmprunt() {
        Date expectedDate = new Date();
        MaterielEmprunte mat = new MaterielEmprunte(new Materiel(),
                new Emprunteur(), expectedDate, 10);
        if (mat.getDateEmprunt() != expectedDate)
            fail("mauvaise date");
        Date date = null;
        MaterielEmprunte mat2 = new MaterielEmprunte(new Materiel(),
                new Emprunteur(), date, 10);
    ...
    public void testGetDureeEmprunt() {
        ...
        MaterielEmprunte mat = new MaterielEmprunte(new Materiel(),
                new Emprunteur(), new Date(), expectedDuree);
    ...
    public void testToString() {
        ...
        String expectedString = expectedMat + "\nEmprunteur : "
                + expectedEmprunteur.getNom().toUpperCase() + " "
                + expectedEmprunteur.getPrenom() + "\nDate d'emprunt : "
                + expectedDate.toString() + "\nDurée d'emprunt : "
                + expectedDureeEmprunt + " jour(s)\n";
